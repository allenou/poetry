...
import type { TShiJing } from "@/typings";
import useTtsEnabled from '@/hooks/useTtsEnabled'
import useTts from '@/hooks/useTts'
import { ref, computed } from 'vue'

const { flattenedData, loading } = useArticle<TShiJing[]>([], {
  flatten: true,
  articleType: 'shijing'
})
...
<template>
  <Article :loading="loading">
    <div class="shijing-page">
      <header class="shijing-header">
        <h1 class="shijing-title">诗经</h1>
        <p class="shijing-description">
